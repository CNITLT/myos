...
CFLAGS = -I./device -I./kernel -I./lib -I./lib/kernel -I./lib/user -I./thread -I./userprog -I./fileSystem -nostdinc -nostdlib -m32 -c -fno-builtin -fno-omit-frame-pointer
LD = ld
...
$(notdir $(wildcard ./kernel/*.c ./device/*.c ./lib/*.c ./lib/kernel/*.c ./lib/user/*.c ./thread/*.c ./userprog/*.c ./fileSystem/*.c)))
