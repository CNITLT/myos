...
#define PIC_EOI asm volatile(" \
    ...
    pop %eax; \
");
#define DEFAULT_EOI asm volatile("nop;");


#define NAKEDFUNC __attribute__((naked))
//代理中断函数，主要用来处理返回到正确的地方,普通函数都是ret返回
#define IDT_FUNC_ENTRY_PROXY(INTERRUPT_NUM, RET_TYPE, EOI_TYPE) \
...
IDT_FUNC_ENTRY_PROXY(0,DEFAULT_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(1,DEFAULT_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(2,DEFAULT_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(3,DEFAULT_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(4,DEFAULT_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(5,DEFAULT_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(6,DEFAULT_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(7,DEFAULT_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(8,ERROR_CODE_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(9,DEFAULT_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(10,ERROR_CODE_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(11,ERROR_CODE_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(12,ERROR_CODE_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(13,ERROR_CODE_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(14,ERROR_CODE_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(15,DEFAULT_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(16,DEFAULT_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(17,ERROR_CODE_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(18,DEFAULT_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(19,DEFAULT_RET,DEFAULT_EOI)
IDT_FUNC_ENTRY_PROXY(20,DEFAULT_RET,PIC_EOI)
IDT_FUNC_ENTRY_PROXY(21,DEFAULT_RET,PIC_EOI)
IDT_FUNC_ENTRY_PROXY(22,DEFAULT_RET,PIC_EOI)
IDT_FUNC_ENTRY_PROXY(23,DEFAULT_RET,PIC_EOI)
IDT_FUNC_ENTRY_PROXY(24,DEFAULT_RET,PIC_EOI)
IDT_FUNC_ENTRY_PROXY(25,DEFAULT_RET,PIC_EOI)
IDT_FUNC_ENTRY_PROXY(26,DEFAULT_RET,PIC_EOI)
IDT_FUNC_ENTRY_PROXY(27,DEFAULT_RET,PIC_EOI)
IDT_FUNC_ENTRY_PROXY(28,DEFAULT_RET,PIC_EOI)
IDT_FUNC_ENTRY_PROXY(29,DEFAULT_RET,PIC_EOI)
IDT_FUNC_ENTRY_PROXY(30,DEFAULT_RET,PIC_EOI)
IDT_FUNC_ENTRY_PROXY(31,DEFAULT_RET,PIC_EOI)
